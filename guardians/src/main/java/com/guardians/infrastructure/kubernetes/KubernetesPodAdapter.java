package com.guardians.infrastructure.kubernetes;
...
public class KubernetesPodAdapter implements KubernetesPodPort {

    private final WargamePort wargamePort;

    private static final String KALI_IMAGE = "public.ecr.aws/i7t0x0a1/gaurdians/wargames:kali";
    ...
    private void createNetworkPolicyForKaliPod(KubernetesClient client, Long userId, String namespace) {
        ...
        NetworkPolicy policy = new NetworkPolicyBuilder()
                ...
                .withNamespaceSelector(new LabelSelectorBuilder()
                        ...
                        .build())
                .endTo()
                .addNewPort().withProtocol("UDP").withPort(new IntOrString(53)).endPort()
                .addNewPort().withProtocol("TCP").withPort(new IntOrString(53)).endPort()
                .endEgress()
                .addNewEgress()
                .addNewTo()
                .withIpBlock(new IPBlockBuilder().withCidr(albIp1).build())
                .endTo()
                .addNewPort().withProtocol("TCP").withPort(new IntOrString(443)).endPort()
                .endEgress()
                .addNewEgress()
                .addNewTo()
